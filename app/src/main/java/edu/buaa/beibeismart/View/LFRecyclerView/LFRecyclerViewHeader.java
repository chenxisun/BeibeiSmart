...
public class LFRecyclerViewHeader extends LinearLayout {
    ...
    private TextView lfrecyclerview_header_time;
    ...
    private void initView(Context context) {
        ...
        mArrowImageView = (ImageView) findViewById(R.id.lfrecyclerview_header_arrow);
        mHintTextView = (TextView) findViewById(R.id.lfrecyclerview_header_hint_textview);
        mProgressBar = (LoadView) findViewById(R.id.lfrecyclerview_header_progressbar);
        lfrecyclerview_header_time=(TextView) findViewById(R.id.lfrecyclerview_header_time);
    ...
    public void setState(int state) {
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                mHintTextView.setText(R.string.lfrecyclerview_header_hint_normal);
            ...
            case STATE_READY:
                if (mState != STATE_READY) {
                    ...
                    mHintTextView.setText(R.string.lfrecyclerview_header_hint_ready);
                }
                break;
            case STATE_REFRESHING:
                mHintTextView.setText(R.string.lfrecyclerview_header_hint_loading);
                break;
            case STATE_SUCCESS:
                mHintTextView.setText(R.string.lfrecyclerview_header_hint_success);
                mArrowImageView.setImageResource(R.drawable.lfrecyclerview_success);
            ...
            case STATE_FRESH_FAILT:
                mHintTextView.setText(R.string.lfrecyclerview_header_hint_failt);
                mArrowImageView.setImageResource(R.drawable.lfrecyclerview_error);
